                ...
                output$chat_vis_overall <- renderUI({
                  tagList(box(title = NULL, width = "60%", strong(paste0(paste("What is known about", input$rename_taxon_ove, "on", input$rename_1_ove, "and", input$rename_2_ove), "?"))),
                          ...
                          box(title = NULL, width = "60%", strong("Reference Search Results"), 
                              ...
                              p("Google Scholar"), 
                              p(" ", style = "margin-bottom: +10px;"),
                              p(tags$a(href = paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_ove, input$rename_1_ove, input$rename_2_ove), paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_ove, input$rename_1_ove, input$rename_2_ove))), 
                              
                              p("PubMed"), 
                              p(" ", style =  "margin-bottom: +10px;"), 
                              p(tags$a(href = paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_ove, input$rename_1_ove, input$rename_2_ove), paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_ove, input$rename_1_ove, input$rename_2_ove))) ), 
              ...
              output$chat_vis_acme <- renderUI({
                tagList(box(title = NULL, width = "60%", strong(paste0(paste("What is known about", input$rename_taxon_acme, "on", input$rename_1_acme, "and", input$rename_2_acme), "?"))),
                        ...
                        box(title = NULL, width = "60%", strong("Reference Search Results"), 
                            ...
                            p("Google Scholar"), 
                            p(" ", style = "margin-bottom: +10px;"),
                            p(tags$a(href = paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_acme, input$rename_1_acme, input$rename_2_acme), paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_acme, input$rename_1_acme, input$rename_2_acme))), 
                            
                            p("PubMed"), 
                            p(" ", style =  "margin-bottom: +10px;"), 
                            p(tags$a(href = paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_acme, input$rename_1_acme, input$rename_2_acme), paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_acme, input$rename_1_acme, input$rename_2_acme))) ), 
              ...
              output$chat_vis_sobel <- renderUI({
                tagList(box(title = NULL, width = "60%", strong(paste0(paste("What is known about", input$rename_taxon_sobel, "on", input$rename_1_sobel, "and",input$rename_2_sobel), "?"))),
                        ...
                        box(title = NULL, width = "60%", strong("Reference Search Results"), 
                            ...
                            p("Google Scholar"), 
                            p(" ", style = "margin-bottom: +10px;"),
                            p(tags$a(href = paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_sobel, input$rename_1_sobel, input$rename_2_sobel), paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon_sobel, input$rename_1_sobel,  input$rename_2_sobel))), 
                            
                            p("PubMed"), 
                            p(" ", style =  "margin-bottom: +10px;"), 
                            p(tags$a(href = paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_sobel,input$rename_1_sobel,input$rename_2_sobel), paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon_sobel, input$rename_1_sobel, input$rename_2_sobel))) )
                )  
              })
                ...
                output$chat_vis <- renderUI({
                  tagList(box(title = NULL, width = "60%", strong(paste0(paste("What is known about", input$rename_taxon, "on", input$rename_1 , "and",input$rename_2), "?"))),
                          ...
                          box(title = NULL, width = "60%", strong("Reference Search Results"), 
                              ...
                              p("Google Scholar"), 
                              p(" ", style = "margin-bottom: +10px;"),
                              p(tags$a(href = paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon, input$rename_1, input$rename_2), paste("https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q=", input$rename_taxon, input$rename_1,  input$rename_2 ))), 
                              
                              p("PubMed"), 
                              p(" ", style =  "margin-bottom: +10px;"), 
                              p(tags$a(href = paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon, input$rename_1,input$rename_2), paste("https://pubmed.ncbi.nlm.nih.gov/?term=", input$rename_taxon, input$rename_1, input$rename_2))))
                  )  
                })
              }) 
            })
