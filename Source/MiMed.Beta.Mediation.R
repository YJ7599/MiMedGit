...
MedTest.bin.bin.plot = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
  ...
  if (mult.test.cor){
    Q_value <- p.adjust(med.test.out$margPs, "BH")
  }
  ...
  for (i in 1:length(beta.treatvar.out$Ds)) {
    ...
    if (mult.test.cor){
      if (Q_value[i] < 0.05) {
        sub.title <- c(sub.title, paste("*q: ", p.value.0.1(Q_value[i]), sep=""))
      }
      if (Q_value[i] >= 0.05) {
        sub.title <- c(sub.title, paste("q: ", p.value.0.1(Q_value[i]), sep=""))
      }
      ...
      if (med.test.out$margPs[i] < 0.05) {
        sub.title <- c(sub.title, paste("*p: ", p.value.0.1(med.test.out$margPs[i]), sep=""))
      }
      if (med.test.out$margPs[i] >= 0.05) {
        sub.title <- c(sub.title, paste("p: ", p.value.0.1(med.test.out$margPs[i]), sep=""))
      }
  ...
  legend("bottom right", paste("Omnibus MedTest: ", P_value(med.test.out$permP), sep=""), bty = "n", cex = 1.15)
  
}

MedTest.con.bin.plot = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.tet.cor) {
  ...
  legend("bottom", paste("Omnibus MedTest: ", P_value(med.test.out$permP), sep=""), bty = "n", cex=1.15)
  
}

MedTest.bin.con.plot = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.con.con.plot = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.bin.bin.plot1 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.bin.bin.plot2 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.con.bin.plot1 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.con.bin.plot2 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.bin.con.plot1 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.bin.con.plot2 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
...
MedTest.con.con.plot2 = function(med.test.out, beta.treatvar.out, beta.outvar.out, mult.test.cor) {
