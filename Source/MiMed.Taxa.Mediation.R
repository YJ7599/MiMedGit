...
# 
#       if (regression.method == "probit") {
#         out.fit <- glm(f2, data = data_cb, family = binomial("probit"))
#       }
#       else if (regression.method == "logistic") {
#         out.fit <- glm(f2, data = data_cb, family = binomial("logit"))
#       } 
# 
#     }else if (regression.method == "linear") {
#       out.fit <- lm(f2, data = data_cbt)
#     }
#     
#     if (method == "quasi-Bayesian") {
#       med.result <- summary(mediate(med.fit, out.fit, treat = exposure, mediator = med,
...
#acme_control, acme_treated, ade_average, total_effect, acme_average 
...
########
# 
# result_med_out_dact <- function (sam.dat, taxa, exposure, outcome, covariates, reg = "linear", interac) {
#   final_list_med <- list() 
#   final_list_out <- list() 
#   
#   for (i in 1:6){
