...
mediation.taxon.ind <- function(sam.dat, taxon_med, taxa_uniq_name,
  ...
  taxon.med <<- taxon_med
  print("hello2") 
  #print(str_replace_all(rownames(sam.dat), rep_str)) 
  
  #rownames(sam.dat) <<- str_replace_all(rownames(sam.dat), rep_str)
  
  print("hello???") 
  print(str_replace_all(colnames(taxon.med), rep_str)) 
  ...
  if(length(taxa_uniq_name) !=0){
    print("hmm_1") 
    print(colnames(taxon.med)[taxa_uniq_name])
...
mediation.taxon.total <- function(sam.dat, taxa, taxa_unique, 
  ...
  for (i in 1:(5+inc)){
    ...
    print("see first") 
    print(is.na(taxa.uniq.pos)) 
    print(sum(taxa.uniq.pos))
    if (is.na(sum(taxa.uniq.pos))){
      if(treat.type == "binary"){
